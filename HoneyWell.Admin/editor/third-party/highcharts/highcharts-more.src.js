...
function initArea(proceed, chart, options) {
	...
	if (this.chart.polar) {
		...
		/**
		 * Overridden method to close a segment path. While in a Typesian plane the area 
 ...
 * Typesian plane, where plotX denotes the angle in radians and (yAxis.len - plotY) is the pixel distance from
 * center. 
 */
