<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_Type_Manage.aspx.cs" Inherits="HoneyWell.Admin.paras.Sys_Type_Manage" %>
...
<body>
    <form id="form1" class="form-horizontal" method="post" enctype="multipart/form-data" runat="server">
        <input type="hidden" id="hdnPKID" value="<%=nodeValue%>" />
        <input type="hidden" id="h_nodeText" value="<%=nodeText%>" />
            ...
            <div class="clearfix">
                <div id="page-content" class="clearfix">
                    <div class="page-header position-relative">
                        <h1>类别管理</h1>
                        <small>&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Style="height: 25px; cursor: hand; cursor: pointer;" Text="删除" OnClientClick="return confirm('您确定进行删除操作吗？')" OnClick="btnDel_Click" />
                            &nbsp;&nbsp;<input type="button" onclick="javascript:location.href='Sys_Type_Add.aspx?nodeText=<%=nodeText%>&nodeValue=<%=nodeValue%>'" style="height: 25px; cursor: hand; cursor: pointer;" value="添加子模块" /></small>
                    </div>
                    <div class="row-fluid">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="txtCCode" runat="server" placeholder="类别编码不能为空" style="width: 150px" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="txtCName" runat="server" placeholder="类别名称不能为空" />
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="txtCOrder" runat="server" style="width: 50px" onkeyup="if(isNaN(value))execCommand('undo')" />
                            </div>
                        </div>
                     ...
                     <button class="btn btn-info" type="button" id="reset"><i class="icon-ok"></i>重置</button>
                        ...
                        <span style="display: none;">
                            <asp:Button ID="btnSave" runat="server" Text="Button" /></span>
    ...
    <script type="text/javascript" language="javascript"> 
        $("#save").click(function () {
            ...
            $.post("../handlers/paras/Sys_Type_Manage.ashx", paras, function (data) {
                alert(data);  
                window.location.href = "Sys_Type_Manage.aspx?nodeText=" + NodeText + "&nodeValue=" + NodeValue + "";
            }, "text");
        });
