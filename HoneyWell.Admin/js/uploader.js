            ...
            uploader.on('uploadSuccess', function (file, data) {
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                        ...
                        addImage(parentObj, data.path, data.nname,"1");
                    }
                    var progressObj = parentObj.children(".upload-progress");
            ...
            uploader.on('uploadSuccess', function (file, data) {
                ...
                if (data.status == '1') {
                    ...
                    if (!p.multiple) {
                        ...
                        addImage(parentObj, data.path, data.nname,"2");
                    }
                    var progressObj = parentObj.children(".upload-progress");
                    progressObj.children(".txt").html("上传成功：" + file.name);
                }
...
=====================================================*/
//添加图片相册
function addImage(targetObj, ImgSrc,ImgName,ImgType) {
    //插入到相册UL里面
    var ImgUrl = $("#ImgUrl").val()
    var newLi = $('<li>'
    + '<input type="hidden" name="ImgName" value="' + ImgName + '" />' 
    + '<div class="img-box">'
    + '<img src="' + ImgUrl + "/upload/product/" + ImgName + '"  onclick="setOpenImg(this.src);" bigsrc="' + ImgUrl + "/upload/product/" + ImgName + '" />'
    + '</div>'
