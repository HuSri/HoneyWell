...
//    A = x.defaultView.getComputedStyle,
    ...
    N.init = function(b, e) {
        ...
        var g;
        if (d(b)) g = f(b);
        else if (c(b)) g = [r.extend({},
        b)],
        b = null;
        else if (D.indexOf(b.nodeType) >= 0 || b === window) g = [b],
        b = null;
        else if (C.test(b)) g = N.fragment(b.trim(), RegExp.$1),
        b = null;
        else {
    ...
    r.map = function(a, b) {
        var c, d, f, h = [];
        if (e(a)) for (d = 0; d < a.length; d++) c = b(a[d], d),
        null != c && h.push(c);
    ...
    r.fn = {
        ...
        ready: function(a) {
            return I.test(x.readyState) ? a(r) : x.addEventListener("DOMContentLoaded",
            function() {
                a(r)
            },
            !1),
        ...
        parents: function(a) {
            for (var b = [], c = this; c.length > 0;) c = r.map(c,
            function(a) {
        ...
        toggleClass: function(a, b) {
            return this.each(function(c) {
                var d = m(this, a, c, this.className); (b === p ? !r(this).hasClass(d) : b) ? r(this).addClass(d) : r(this).removeClass(d)
            })
        }
    },
...
function(a) {
    function b(a) {
        ...
        j = a.match(/Kindle\/([\d.]+)/),
        k = a.match(/Silk\/([\d._]+)/),
        l = a.match(/(BlackBerry).*Version\/([\d.]+)/); (c.webkit = !!d) && (c.version = d[1]),
...
$(function() {
    ...
    _WXShare('http://www.housetencent.com/pinzhenyuan/images/fxlogo.png', '120', '124', '品臻園微楼书', '欢迎关品臻園官方网站', 'http://www.housetencent.com/pinzhenyuan/welcome.html', '');
