    ...
    var L = function(h) {
        var j = function(e) {
            ...
            function ua(a) {
                ...
                for (i = a.aoColumns.length; c < i; c++) {
                    ...
                    if (w || o || k || !n) {
                        ...
                        e.mRender ? m.innerHTML = v(a, g, c, "display") : e.mData !== c && (m.innerHTML = v(a,
            ...
            function O(a, b) {
                ...
                q[c].bSortable ? 0 < o.length && o[0][0] == c ? (i.setAttribute("aria-sort", "asc" == o[0][1] ? "ascending": "descending"), i.setAttribute("aria-label", e + ("asc" == (q[c].asSorting[o[0][2] + 1] ? q[c].asSorting[o[0][2] + 1] : q[c].asSorting[0]) ? G.sSortAscending: G.sSortDescending))) : i.setAttribute("aria-label",
            ...
            this.fnDestroy = function(a) {
                ...
                i = 0;
                for (f = b.aoData.length; i < f; i++) null !== b.aoData[i].nTr && d.appendChild(b.aoData[i].nTr); ! 0 === b.oFeatures.bAutoWidth &&
        ...
        j.fnVersionCheck = function(e) {
            ...
            e = e.split("."), k = "", n = "", l = 0, t = e.length; l < t; l++) k += h(m[l], 3),
            n += h(e[l], 3);
        ...
        j.defaults = {
            ...
            oLanguage: {
                ...
                sInfo: "显示 _START_- _END_ 共有 _TOTAL_ 项",
                sInfoEmpty: "显示 0 到 0 of 0 项",
            ...
            full_numbers: {
                ...
                fnUpdate: function(e, o) {
                    if (e.aanFeatures.p) {
                        ...
                        u.hasChildNodes() && (h("span:eq(0)", u).html(t).children("a").each(L), u = u.getElementsByTagName("a"), u = [u[0], u[1], u[u.length - 2], u[u.length - 1]], h(u).removeClass(B.sPageButton + " " + B.sPageButtonActive + " " + B.sPageButtonStaticDisabled), h([u[0], u[1]]).addClass(1 == n ? B.sPageButtonStaticDisabled:
